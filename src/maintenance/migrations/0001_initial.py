# Generated by Django 5.0.14 on 2026-03-22 20:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=100, unique=True, verbose_name='Lokalizacja (Hala/Linia)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('L', 'Niski'), ('M', 'Średni'), ('H', 'Wysoki'), ('C', 'Krytyczny')], default=[('L', 'Niski'), ('M', 'Średni'), ('H', 'Wysoki'), ('C', 'Krytyczny')], max_length=1, verbose_name='Priorytet')),
